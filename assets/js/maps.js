...
function initialize() {
  ...
  //Jemazar
  point = new google.maps.LatLng(19.47823, -70.68766);
  marker = createMarker(point,"Jemazar","<strong>Jemazar</strong><br>Empresa dominicana dedicada a la distribución de productos lácteos, cárnicos, pescados y mariscos de la más alta calidad con precios competitivos.",iconjemazar);
